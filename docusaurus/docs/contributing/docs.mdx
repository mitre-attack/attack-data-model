...
The top-level package script `docs:schemamarkdown` is used to automate the process of converting Zod schemas into Markdown. 
...
To start the local development server without opening a browser window use the following command.
