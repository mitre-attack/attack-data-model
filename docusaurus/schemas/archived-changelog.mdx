...
This changelog previously was hosted in https://github.com/mitre/cti and is included only for historical context.
Links have been updated to point to currently existing locations and minor tweaks have been made to refer to existing documentation.
They may however break over time as this page is not actively maintained.
...
* Added Asset objects. For detailed information about the representation of Assets in ATT&CK/STIX,
  please see the [Asset schema](./sdo/asset.schema).
...
* Added Campaign objects. For detailed information about the representation of Campaigns in ATT&CK/STIX,
  please see the [Campaign schema](./sdo/campaign.schema).
...
|:--------|:-----------------------------------------------------:|:-------------------------------------------------------------------------:|
| Added full objects for data sources and data components. See the [Data Source](./sdo/data-source.schema) and [Data Component](./sdo/data-component.schema) schemas for more information about data sources, data components, and their relationships with techniques. | :white_check_mark: | :white_check_mark: |
...
1. Added sub-techniques:
    ...
    For more information about the representation of sub-techniques in STIX, please see the [technique schema](./sdo/technique.schema).
...
We've also rewritten the [USAGE](https://github.com/mitre/cti/blob/master/USAGE.md) document with additional information about the ATT&CK data model and more examples of how to access and use ATT&CK in Python.
