describe('Global Tests', () => {
    describe('ATT&CK Testing Data', () => {
        ...
        it('should have loaded STIX Bundles', () => {
            ...
            expect(globalThis.attackData.bundles.every(bundle =>
        ...
        it('should have correct number of objects in allObjects matching total objects in bundles', () => {
            const totalObjectsInBundles = globalThis.attackData.bundles.reduce((sum, bundle) => sum + bundle.objects.length, 0);
        ...
        it('should have software objects (combination of malware and tools)', () => {
            ...
            expect(globalThis.attackData.objectsByType['software'].length).toEqual(
                globalThis.attackData.objectsByType['malware'].length + globalThis.attackData.objectsByType['tool'].length
            );
        });
        ...
        it('should have data sources and data components', () => {
            ...
            expect(globalThis.attackData.objectsByType['x-mitre-data-component'].length).toBeGreaterThan(0);
        });
        ...
        it('should have correct number of objects in allObjects', () => {
            const totalObjectCount = Object.values(globalThis.attackData.objectsByType).reduce((sum, arr) => sum + arr.length, 0);
            // Subtract software count as it's a duplicate of malware and tool
            const adjustedCount = totalObjectCount - globalThis.attackData.objectsByType['software'].length;
        ...
        it('should have correct number of SDOs', () => {
            ...
            const sdoCount = sdoTypes.reduce((sum, type) => sum + (globalThis.attackData.objectsByType[type]?.length || 0), 0);
