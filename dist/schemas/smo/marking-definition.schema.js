...
import { createStixIdentifierSchema, nameSchema, stixCreatedByRefSchema, stixSpecVersionSchema, stixTimestampSchema, xMitreAttackSpecVersionSchema, xMitreDomainsSchema, } from '../common/index.js';
/////////////////////////////////////
//
// TLP Marking Object
//
...
export const markingDefinitionSchema = z
    ...
    created_by_ref: stixCreatedByRefSchema.describe('The ID of the Source object that describes who created this object.'),
    // Deprecated in STIX
    // Optional in STIX but required in ATT&CK
    definition_type: z
        .enum(['statement', 'tlp'], {
    ...
    .strict();
//# sourceMappingURL=marking-definition.schema.js.map