...
import { createStixIdentifierSchema, externalReferencesSchema, objectMarkingRefsSchema, stixCreatedByRefSchema, xMitreDomainsSchema, xMitreModifiedByRefSchema, } from '../common/index.js';
...
export const mitigationSchema = attackBaseObjectSchema
    ...
    // Optional in STIX but required in ATT&CK
    external_references: externalReferencesSchema.describe('A list of external references which refers to non-STIX information.'),
    // Optional in STIX but required in ATT&CK
...
//# sourceMappingURL=mitigation.schema.js.map