...
import { aliasesSchema, createStixIdentifierSchema, externalReferencesSchema, stixTimestampSchema, xMitreDomainsSchema, xMitreModifiedByRefSchema, } from '../common/index.js';
import { attackMotivationOpenVocabulary, attackResourceLevelOpenVocabulary, } from '../common/open-vocabulary.js';
// Group Schema
export const groupSchema = attackBaseObjectSchema
    ...
    description: z
        .string()
        .optional()
        .describe('A description that provides more details and context about the Intrusion Set, potentially including its purpose and its key characteristics.'),
