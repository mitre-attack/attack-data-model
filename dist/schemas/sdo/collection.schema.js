...
export const objectVersionReferenceSchema = z.object({
    ...
    object_modified: stixModifiedTimestampSchema.describe('The modified time of the referenced object. It MUST be an exact match for the modified time of the STIX object being referenced.'),
});
...
export const collectionSchema = attackBaseObjectSchema
    ...
    description: descriptionSchema.describe('Details, context, and explanation about the purpose or contents of the collection.'),
