...
import { descriptionSchema, xMitrePlatformsSchema, attackDomainSchema, createStixIdentifierSchema, xMitreModifiedByRefSchema, xMitreDomainsSchema, xMitreContributorsSchema, externalReferencesSchema, killChainPhaseSchema, } from '../common/index.js';
// Initializes the custom ZodErrorMap
import '../../errors';
// read only type reference
const TECHNIQUE_TYPE = stixTypeSchema.enum['attack-pattern'];
/////////////////////////////////////
//
...
//
/////////////////////////////////////
const supportedMitreEffectivePermissions = ['Administrator', 'SYSTEM', 'User', 'root'];
export const xMitreEffectivePermissionsSchema = z
    ...
    message: 'x_mitre_effective_permissions may only contain values from the following list: ' +
...
//
/////////////////////////////////////
const supportedMitreImpactTypes = ['Availability', 'Integrity'];
...
export const xMitrePermissionsRequiredSchema = z
    ...
    message: 'x_mitre_permissions_required may only contain values from the following list: ' +
...
export const xMitreTacticTypeSchema = z
    ...
    message: 'x_mitre_tactic_type may only contain values from the following list: ' +
...
export const techniqueSchema = attackBaseObjectSchema
    ...
    const { external_references, kill_chain_phases, x_mitre_domains, x_mitre_permissions_required, x_mitre_effective_permissions, x_mitre_system_requirements, x_mitre_defense_bypassed, x_mitre_remote_support, x_mitre_impact_type, x_mitre_is_subtechnique, x_mitre_tactic_type, x_mitre_data_sources, } = schema;
     ...
     */
    function validateEnterpriseOnlyField(fieldName, value, requiredTactic = null) {
        if (value !== undefined) {
...
//# sourceMappingURL=technique.schema.js.map