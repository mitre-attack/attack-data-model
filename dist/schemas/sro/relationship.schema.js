...
import { createStixIdentifierSchema, descriptionSchema, objectMarkingRefsSchema, stixIdentifierSchema, stixTypeSchema, xMitreAttackSpecVersionSchema, xMitreDeprecatedSchema, xMitreDomainsSchema, xMitreModifiedByRefSchema, xMitreVersionSchema, } from '../common/index.js';
// Initializes the custom ZodErrorMap
import '../../errors';
// read only type reference
const RELATIONSHIP_TYPE = stixTypeSchema.enum.relationship;
/////////////////////////////////////
//
// Relationship Types
// (relationship_type)
 ...
 */
export function isValidRelationship(sourceType, relationshipType, targetType, errorCollector) {
 ...
 */
const allRelationships = stixTypeSchema.options.flatMap((source) => stixTypeSchema.options.flatMap((target) => relationshipTypeSchema.options.map((relType) => ({
    sourceType: source,
 ...
 */
export const invalidRelationships = allRelationships.filter((rel) => !isValidRelationship(rel.sourceType, rel.relationshipType, rel.targetType));
/////////////////////////////////////
//
// Relationship
//
...
export const relationshipSchema = stixRelationshipObjectSchema
    ...
    const [sourceType] = source_ref.split('--');
    const [targetType] = target_ref.split('--');
