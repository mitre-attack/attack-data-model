...
import { stixCreatedByRefSchema, granularMarkingSchema, extensionsSchema, externalReferencesSchema, } from './misc.js';
import { objectMarkingRefsSchema } from './common-properties.js';
const stixBaseObjectSchema = z
    .object({
    id: stixIdentifierSchema.describe('The id property universally and uniquely identifies this object.'),
    type: stixTypeSchema,
    spec_version: stixSpecVersionSchema.describe('The version of the STIX specification used to represent this object.'),
    created: stixCreatedTimestampSchema.describe('The created property represents the time at which the first version of this object was created. The timstamp value MUST be precise to the nearest millisecond.'),
    modified: stixModifiedTimestampSchema.describe('The modified property represents the time that this particular version of the object was modified. The timstamp value MUST be precise to the nearest millisecond.'),
...
//# sourceMappingURL=stix-core.js.map