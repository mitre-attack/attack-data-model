import { z } from 'zod';
export declare const MalwareTypeOpenVocabulary: z.ZodEnum<["adware", "backdoor", "bot", "bootkit", "ddos", "downloader", "dropper", "exploit-kit", "keylogger", "ransomware", "remote-access-trojan", "resource-exploitation", "rogue-security-software", "rootkit", "screen-capture", "spyware", "trojan", "virus", "webshell", "wiper", "worm", "unknown"]>;
export declare const ProcessorArchitecturesOpenVocabulary: z.ZodEnum<["alpha", "arm", "ia-64", "mips", "powerpc", "sparc", "x86", "x86-64"]>;
export declare const ImplementationLanguagesOpenVocabulary: z.ZodEnum<["applescript", "bash", "c", "c++", "c#", "go", "java", "javascript", "lua", "objective-c", "perl", "php", "powershell", "python", "ruby", "scala", "swift", "typescript", "visual-basic", "x86-32", "x86-64"]>;
export declare const MalwareCapabilitiesOpenVocabulary: z.ZodEnum<["accesses-remote-machines", "anti-debugging", "anti-disassembly", "anti-emulation", "anti-memory-forensics", "anti-sandbox", "anti-vm", "captures-input-peripherals", "captures-output-peripherals", "captures-system-state-data", "cleans-traces-of-infection", "commits-fraud", "communicates-with-c2", "compromises-data-integrity", "compromises-data-availability", "compromises-system-availability", "controls-local-machine", "degrades-security-software", "degrades-system-updates", "determines-c2-server", "emails-spam", "escalates-privileges", "evades-av", "exfiltrates-data", "fingerprints-host", "hides-artifacts", "hides-executing-code", "infects-files", "infects-remote-machines", "installs-other-components", "persists-after-system-reboot", "prevents-artifact-access", "prevents-artifact-deletion", "probes-network-environment", "self-modifies", "steals-authentication-credentials", "violates-system-operational-integrity"]>;
export declare const ToolTypesOpenVocabulary: z.ZodEnum<["denial-of-service", "exploitation", "information-gathering", "network-capture", "credential-exploitation", "remote-access", "vulnerability-scanning", "unknown"]>;
export declare const identityClassOpenVocabulary: z.ZodEnum<["individual", "group", "system", "organization", "class", "unspecified"]>;
/**
 ...
 */
export declare const attackMotivationOpenVocabulary: z.ZodEnum<["accidental", "coercion", "dominance", "ideology", "notoriety", "organizational-gain", "personal-gain", "personal-satisfaction", "revenge", "unpredictable"]>;
/**
 ...
 */
export declare const attackResourceLevelOpenVocabulary: z.ZodEnum<["individual", "club", "contest", "team", "organization", "government"]>;
/**
