...
export function createStixIdentifierSchema(expectedType) {
    return stixIdentifierSchema.refine((val) => val.startsWith(`${expectedType}--`), {
 ...
 */
//# sourceMappingURL=stix-identifier.js.map