 ...
 */
export const invalidRelationships: RelationshipCombination[] = allRelationships.filter(rel =>
	!isValidRelationship(rel.sourceType, rel.relationshipType, rel.targetType)
);
