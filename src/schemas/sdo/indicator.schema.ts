...
export const indicatorSchema = attackBaseObjectSchema
  .extend({
    ...
    name: z
      ...
      .optional()
      .meta(
        { description: 'A name used to identify the Indicator. Producers SHOULD provide this property to help products and analysts understand what this Indicator actually does.' }
      ),
    ...
    description: z
      ...
      .optional()
      .meta(
        { description: 'A description that provides more details and context about the Indicator, potentially including its purpose and its key characteristics. Producers SHOULD provide this property to help products and analysts understand what this Indicator actually does.' }
      ),

    indicator_types: IndicatorTypeOV.optional().meta(
      { description: 'A set of categorizations for this indicator. The values for this property SHOULD come from the indicator-type-ov open vocabulary.' }
    ),
