...
export const xMitreTacticRefsSchema = z
  .array(
    createStixIdentifierSchema('x-mitre-tactic')
  )
  .describe("An ordered list of x-mitre-tactic STIX IDs corresponding to the tactics of the matrix. The order determines the appearance within the matrix.");
