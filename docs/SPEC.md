...
- Each `(name, channel)` tuple must be unique within a log source's permutations array
- The parent log source's `name` field indicates the associated data component
